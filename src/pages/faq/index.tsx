    ...
    <div className="faq_page">
      <div className="faq_page_wrapper">
        <div className="faq_page_container">
          ...
          <div className="faq_box_wrapper">
            <div className="faq_box faq_box_container">
              <div className="faq_box_content">

                <div className="faq_box_wrapper">
                  <div className="faq_box faq_header_image">
                    <div>
                      <div className="faq_box_content">
                        <div className="faq_header_text">
                          <div>
                            <div></div>
                            <div>
                              <div className="faq_header_text_h1_container">
                                <h1>FAQ!</h1>
                              </div>
                            </div>
                            <div></div>
                ...
                <div className="faq_box_content_body">
                  <div className="faq_c faq_box_row_wrapper faq_box_row_container">
                    <div className="faq_box_row">

                      <div className="faq_box_row_left">
                        <div>
                          <div>
                            <div>
                              <div>
                                ...
                                <div className="faq_c faq_box_row_left_header">
                                  <div>
                                    <h2 className="faq_box_row_left_header_wrapper_h2">DUMPLINGS QUESTIONS</h2>
                                  </div>
                                </div>
                                        ...
                                        <div className="faq_c faq_box_row_left_body_tab_body_text_wrapper">
                                          <div className="faq_box_row_left_body_tab_body_text">
                                            <ol>
                                              <li>
                                                <span>
                                                  <span>We make all our dumplings out of our Edison Location every morning, we freeze them and then pack and deliver to your door the next day!</span>
                                                </span>
                                              </li>
                                            </ol>
                                          </div>
                                        ...
                                        <div className="faq_c faq_box_row_left_body_tab_body_text_wrapper">
                                          <div className="faq_box_row_left_body_tab_body_text">
                                            <ol>
                                              <li>
                                                <span>
                                                  <span>We have a bunch of new recipes on the roadmap - if you really want a flavor to happen, please email us at delivery@kaitodumplings.com!</span>
                                                </span>
                                              </li>
                                            </ol>
                                          </div>
                                        ...
                                        <div className="faq_c faq_box_row_left_body_tab_body_text_wrapper">
                                          <div className="faq_box_row_left_body_tab_body_text">
                                            <ol>
                                              <li>
                                                <span>
                                                  <span>All ingredients & nutrition labels can be found on our product pages!</span>
                                                </span>
                                              </li>
                                            </ol>
                                          </div>
                          ...
                          <div>
                            <div>
                              <div>
                                <div className="faq_c faq_box_row_left_header">
                                  <div>
                                    <h2 className="faq_box_row_left_header_wrapper_h2">OTHER</h2>
                                  </div>
                                </div>
                                <div className="faq_c faq_box_row_left_body">
                                  <div>
                                        ...
                                        <div className="faq_c faq_box_row_left_body_tab_body_text_wrapper">
                                          <div className="faq_box_row_left_body_tab_body_text">
                                            <ol>
                                              <li>
                                                <span>
                                                  <span>Rest assured that we’re not changing anything about our recipes, techniques, or the quality of our ingredients. You’ll still be getting all the same delicious Chinese food you know and love.</span>
                                                </span>
                                              </li>
                                            </ol>
                                          </div>
                      ...
                      <div className="faq_box_row_right">
                        <div className="faq_box_row_right_wrapper">
                          <div className="faq_box faq_c faq_box_row_right_container">
                            <div className="faq_box_content">
                              <div className="faq_c faq_box_row_right_header">
                                <div>
                                  <h3 className="faq_box_row_right_header_h3">STILL HAVE ANY QUESTIONS?</h3>
                                </div>
                              </div>
                              <div className="faq_c faq_box_row_right_body">
                                <div className="faq_box_row_right_body_wrapper">
                                  <ul>
                                    <li>
                                      <span>
                                        <a href="mailto:kaitodumplings@gmail.com">delivery@kaitodumplings.com</a>
                                      </span>
                                      <br />
                                      <span>(our customer support team!)</span>
                                    </li>
                                  </ul>
                                  <p>&nbsp;</p>
                                  <p>
                                    <span>DM Us on Instagram or
                                    <br />
