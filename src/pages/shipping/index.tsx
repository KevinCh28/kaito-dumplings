...
const Shipping: NextPage = () => {
  useEffect(() => {
    ...
    const element2 = window.document.getElementsByClassName('off_canvas_main_content')[0] as HTMLDivElement;
    element2.style.backgroundColor = 'rgb(212, 255, 208)';
  }, []);
