...
export const increaseItemQuantity = async (userId: string, productId: string, amount: number) => {
  return await axios.put(`/api/carts/${userId}/increase`, { userId, productId, amount });
}
